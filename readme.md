![INSIDE](https://inside.ddns.net/inside/includes/icons/common/inside_readme.png)

# INSIDE - Plateforme de partage créée par les membres pour les membres.

## Lien
Site accessible depuis le lien suivant : [INSIDE](https://inside.ddns.net/inside/index.php?action=goConsulter)
...
Une procédure d'installation de la solution en local est fournie dans le dossier "tools" à la racine du projet.
...
| Violet moyen  | ![#9858ba](https://place-hold.it/15/9858ba/000000?text=+) | #9858ba  |                    | Pour calendriers                       |
| Violet foncé  | ![#8d44b6](https://place-hold.it/15/8d44b6/000000?text=+) | #8d44b6  |                    | Pour calendriers                       |
| Blanc         | ![#ffffff](https://place-hold.it/15/ffffff/000000?text=+) | #ffffff  | rgb(255, 255, 255) |                                        |
| Blanc cassé   | ![#fefee2](https://place-hold.it/15/fefee2/000000?text=+) | #fefee2  |                    | Pour calendriers                       |
| Blanc ivoire  | ![#cfcfb8](https://place-hold.it/15/cfcfb8/000000?text=+) | #cfcfb8  |                    | Pour calendriers                       |
...
| generator | Contient les paramètres du générateur de code            |
