<?php
  echo '<div class="zone_profil_bottom_left">';
    echo '<div class="titre_section"><img src="../includes/icons/profil/connexion_grey.png" alt="connexion_grey" class="logo_titre_section" />Utilisateur</div>';
    ...
    echo '<div class="zone_action_user">';
      ...
      if ($profil->getStatus() == "Y")
      {
        ...
        echo '<form method="post" action="profil.php?user=' . $profil->getIdentifiant() . '&action=cancelResetPassword" class="margin_top">';
    ...
    echo '<div class="zone_action_user">';
      ...
      {
        // Annulation
        echo '<form method="post" action="profil.php?user=' . $profil->getIdentifiant() . '&action=cancelDesinscription" class="margin_top">';
      ...
      {
        // Désinscription
        echo '<form method="post" action="profil.php?user=' . $profil->getIdentifiant() . '&action=askDesinscription" class="margin_top">';
