<?php
  ...
  function getHistory()
  {
    ...
    // Introduction
    $story = array('Inside c\'est avant tout votre histoire. C\'est pour vous que le site a été façonné mais c\'est par vous qu\'il s\'est accompli. De son origine à son état actuel, le site
    ...
    $story = array('16 et 20 Avril 2022',
    ...
    // A vous de jouer
    $story = array(date('j') . ' ' . formatMonthForDisplay(date('m')) . ' ' . date('Y'),
