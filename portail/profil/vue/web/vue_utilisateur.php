    ...
    echo '<div class="zone_profil_bottom_left">';
        ...
        echo '<div class="zone_action_user">';
            ...
            if ($profil->getStatus() == 'P')
            {
                ...
                echo '<form method="post" action="profil.php?action=doAnnulerMotDePasse" class="margin_top_20">';
        ...
        echo '<div class="zone_action_user">';
            ...
            {
                echo '<form method="post" action="profil.php?action=doModifierEquipe">';
        ...
        echo '<div class="zone_action_user">';
            ...
            {
                // Annulation
                echo '<form method="post" action="profil.php?action=doAnnulerDesinscription" class="margin_top_20">';
            ...
            {
                // Désinscription
                echo '<form method="post" action="profil.php?action=doDemanderDesinscription" class="margin_top_20">';
