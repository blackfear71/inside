                                ...
                                echo '<form method="post" action="calendars_generator.php?action=doGenerer" enctype="multipart/form-data" id="form_saisie_generator">';
                                    ...
                                    echo '<div class="zone_options_calendrier">';
                                        ...
                                        echo '<div id="zone_option_couleur" class="zone_option_calendrier">';
                                            ...
                                            {
                                                echo '<div class="zone_bouton_option zone_bouton_option_demi_margin zone_bouton_option_violet">';
                                            ...
                                            {
                                                echo '<div class="zone_bouton_option zone_bouton_option_demi zone_bouton_option_blanc">';
