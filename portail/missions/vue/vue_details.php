        ...
        <?php
          if ($missionExistante == true)
          {
            echo '<table cellpadding="0" class="table_mission">';
              ...
              // Objectif
              echo '<tr>';
                echo '<td class="sous_titre_details_mission">';
                  echo 'Objectif journalier';
                echo '</td>';

                echo '<td class="ligne_details_mission">';
              ...
              if (date('Ymd') <= $detailsMission->getDate_fin())
              {
                echo '<tr>';
                  echo '<td class="sous_titre_details_mission">';
                    echo '<div >Aujourd\'hui</div>';
                  echo '</td>';

                  echo '<td class="ligne_details_mission" style="text-align: center;">';
