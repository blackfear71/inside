<?php
    ...
    echo '<div class="zone_details_parcours">';
        ...
        echo '<div class="zone_informations_details_parcours">';
            ...
            // Nombre de courses personnelles
            echo '<div class="zone_donnee_details_parcours">';
                echo '<img src="../../includes/icons/petitspedestres/proud_grey.png" alt="proud_grey" title="Nombre de courses réalisées par moi" class="icone_donnee_details_parcours" />';

                if ($detailsParcours->getMyRuns() == 1)
                    echo '<div class="donnee_details_parcours">' . $detailsParcours->getMyRuns() . ' course réalisée par moi</div>';
                else
                    echo '<div class="donnee_details_parcours">' . $detailsParcours->getMyRuns() . ' courses réalisées par moi</div>';
            echo '</div>';
            ...
            // Participation
            echo '<a id="ajouter_participation_' . $detailsParcours->getId() . '" title="Participer à cette course" class="zone_donnee_details_parcours_lien afficherSaisieParticipation">';
