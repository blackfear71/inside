<?php
    ...
    echo '<div class="zone_tableau_de_bord">';
        ...
        echo '<div class="titre_section">';
            echo '<img src="../../includes/icons/petitspedestres/speed_grey.png" alt="speed_grey" class="logo_titre_section" />';
            echo '<div class="texte_titre_section">Tableau de bord</div>';
        echo '</div>';
