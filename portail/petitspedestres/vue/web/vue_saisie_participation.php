    ...
    echo '<div id="zone_saisie_participation" class="fond_saisie">';
        echo '<div class="zone_saisie">';
            ...
            echo '<div class="zone_titre_saisie">';
                // Texte
                echo '<div class="texte_titre_saisie"></div>';

                // Bouton fermeture
                echo '<a id="annulerParticipation" class="bouton_fermeture_saisie"><img src="../../includes/icons/common/close.png" alt="close" title="Fermer" class="image_fermeture_saisie" /></a>';
            echo '</div>';
