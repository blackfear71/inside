    ...
    foreach ($notifications as $notification)
    {
      ...
      switch ($notification->getCategory())
      {
        case "film":
          ...
          $icone  = "movie_house";
          $phrase = "Le film <strong>" . $titre_film . "</strong> vient d'être ajouté ! Allez vite le voir :)";
        ...
        case "culte":
          ...
          $icone  = "collector";
          $phrase = "<strong>" . $speaker . "</strong> en a encore dit une belle ! Merci <strong>" . $author . "</strong> ;)";
