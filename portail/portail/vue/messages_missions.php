<?php
  ...
  {
    echo '<div class="zone_messages_missions">';
      foreach ($messagesMissions as $keyMission => $mission)
      {
        ...
        echo '<div class="zone_resume_mission">';
          echo '<div class="zone_resume_mission_logo">';
            echo '<img src="/inside/includes/icons/common/missions.png" alt="missions" class="logo_resume_mission" />';
          echo '</div>';
          ...
          // Mission > 1 jour (terminée, jour de fin + 3 jours)
