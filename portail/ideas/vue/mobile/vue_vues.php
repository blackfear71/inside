        ...
        echo '<div class="div_saisie">';
            ...
            echo '<div class="zone_contenu_saisie">';
                echo '<div class="contenu_saisie">';
                    ...
                    {
                        if ($_GET['view'] == $keyVue)
                            echo '<a href="ideas.php?view=' . $keyVue . '&action=goConsulter&page=1" class="lien_saisie lien_courant">' . $vue . '</a>';
                        else
                            echo '<a href="ideas.php?view=' . $keyVue . '&action=goConsulter&page=1" class="lien_saisie">' . $vue . '</a>';
                    }
                echo '</div>';
            echo '</div>';
