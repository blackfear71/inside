		...
		{		
			...
			echo '<tr class="ligne_tableau_movie_house">';
				...
				elseif ($donnees2['participation'] == "P")
					...
					echo '<a onclick="afficherMasquer(\'preference[' . $i . ']\'); afficherMasquer(\'preference2[' . $i . ']\');" id="preference[' . $i . ']" title="Préférence" class="link_vote" style="margin-left: auto; margin-right: auto; background-color: transparent;">';
					...
					echo '<form method="post" action="moviehouse/submit_film.php?view=' . $_GET['view'] . '&year=' . $_GET['year'] . '&id_film=' . $donnees['id'] . '" id="preference2[' . $i . ']" style="display: none; min-width: 160px;">';
						// Boutons vote
						for($j = 0; $j <= 3; $j++)
						{
