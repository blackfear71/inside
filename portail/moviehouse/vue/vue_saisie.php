                    ...
                    echo '<div class="zone_saisie_avancee_infos">';
                      ...
                      echo '<div class="zone_icone_saisie">';
                        ...
                        if (isBlankDate($film->getDate_theater()))
                          echo '<input type="text" name="date_theater" value="" placeholder="Date de sortie cinéma (jj/mm/yyyy)" maxlength="10" autocomplete="off" id="datepicker_sortie_1" class="monoligne_film" />';
                        else
                          echo '<input type="text" name="date_theater" value="' . formatDateForDisplay($film->getDate_theater()) . '" placeholder="Date de sortie cinéma (jj/mm/yyyy)" maxlength="10" autocomplete="off" id="datepicker_sortie_1" class="monoligne_film" />';
                      echo '</div>';

                      // Date de sortie DVD
                      echo '<div class="zone_icone_saisie">';
                        echo '<img src="../../includes/icons/moviehouse/date.png" alt="date" title="Date de sortie DVD/Bluray" class="icone_saisie" />';
                        echo '<input type="text" name="date_release" value="' . formatDateForDisplay($film->getDate_release()) . '" placeholder="Date de sortie DVD/Bluray (jj/mm/yyyy)" maxlength="10" autocomplete="off" id="datepicker_sortie_2" class="monoligne_film" />';
                      echo '</div>';
                    ...
                    echo '<div class="zone_saisie_avancee_orga">';
                      ...
                      echo '</div>';
                        ...
                        echo '<div class="zone_icone_saisie">';
                          ...
                          echo '<input type="text" name="date_doodle" value="' . formatDateForDisplay($film->getDate_doodle()) . '" placeholder="Date proposée (jj/mm/yyyy)" maxlength="10" autocomplete="off" id="datepicker_doodle" class="monoligne_film_short" />';
