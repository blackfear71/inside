  ...
  <head>
    ...
    <section class="section_index">
      ...
      <article class="article_index">
        <?php
          echo '<div class="zone_top_index">';
            echo '<div class="zone_top_left_index">';
              // Logo Inside
              echo '<div class="zone_top_left_top_index">';
                echo '<img src="includes/icons/common/inside_index.png" alt="inside_index" class="logo_index" />';
              echo '</div>';

              // Logos catégories
              echo '<div class="zone_top_left_bottom_index">';
            ...
            echo '<div class="zone_top_right_index">';
              // Connexion
            ...
            echo '<div class="rift_1"></div>';
            echo '<div class="rift_2"></div>';
          echo '</div>';
          ...
          if ($error_inscription == true)
            ...
            echo '<form method="post" action="index.php?action=doDemanderInscription" class="form_index_ins_pass">';
          ...
          if ($error_password == true)
            ...
            echo '<form method="post" action="index.php?action=doDemanderMdp" class="form_index_ins_pass">';
