<?php
    ...
    $listeAsidePortail = array(
        array(
            'lien'  => '/inside/portail/portail/portail.php?action=goConsulter',
            'image' => 'inside_white',
            'titre' => 'PORTAIL'
        ),
        array(
        ...
        array(
            'lien'  => '/inside/portail/cookingbox/cookingbox.php?year=' . date('Y') . '&action=goConsulter',
            'image' => 'cooking_box',
            'titre' => 'COOKING BOX'
        ),
        array(
            'lien'  => '/inside/portail/expensecenter/expensecenter.php?year=' . date('Y') . '$filter=all&action=goConsulter',
        ...
        array(
            'lien'  => '/inside/portail/calendars/calendars.php?year=' . date('Y') . 'action=goConsulter',
            'image' => 'calendars',
            'titre' => 'CALENDARS'
        ),
        array(
    ...
    $listeAsideUser = array(
        array(
            'lien'  => '/inside/portail/profil/profil.php?view=settings&action=goConsulter',
            'image' => 'settings',
            'titre' => 'PARAMÈTRES'
        ),
        array(
            'lien'  => '/inside/portail/profil/profil.php?view=success&action=goConsulter',
            'image' => 'cup',
            'titre' => 'SUCCÈS'
        ),
        array(
            'lien'  => '/inside/portail/profil/profil.php?view=themes&action=goConsulter',
            'image' => 'themes',
            'titre' => 'THÈMES'
        ),
        array(
            'lien'  => '/inside/includes/functions/script_commun.php?function=disconnectUser',
            'image' => 'logout',
            'titre' => 'DÉCONNEXION'
        )
    );
