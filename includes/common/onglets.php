<?php
  ...
  echo '<nav class="menu_nav">';
		...
		$onglet4 = '<a href="/inside/portail/expensecenter/expensecenter.php?year=' . date('Y') . '&action=goConsulter" title="Expense Center" class="onglet_inactif"><img src="/inside/includes/icons/common/expense_center.png" alt="expense_center" title="Expense Center" class="logo_onglet" /></a>';
		...
		$onglet7 = '<a href="/inside/portail/petitspedestres/parcours.php?action=liste" title="Les Petits Pédestres" class="onglet_inactif"><img src="/inside/includes/icons/common/petits_pedestres.png" alt="petits_pedestres" title="Les Petits Pédestres" class="logo_onglet" /></a>';
		...
		{
			$onglet4 = '<a href="/inside/portail/expensecenter/expensecenter.php?year=' . date('Y') . '&action=goConsulter" title="Expense Center" class="onglet_actif"><img src="/inside/includes/icons/common/expense_center.png" alt="expense_center" title="Expense Center" class="logo_onglet" /></a>';
		}
		...
		{
			$onglet7 = '<a href="/inside/portail/petitspedestres/parcours.php?action=liste" class="onglet_actif" title="Les Petits Pédestres"><img src="/inside/includes/icons/common/petits_pedestres.png" alt="petits_pedestres" title="Les Petits Pédestres" class="logo_onglet" /></a>';
		}
