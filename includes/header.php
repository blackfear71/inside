<div class="zone_bandeau">
  <div class="zone_bandeau_left">
    <!-- Logo -->
    <a href="http://localhost/inside/portail/portail/portail.php?action=goConsulter">
      <img src="/inside/includes/icons/inside.png" alt="inside" class="logo_bandeau" />
    </a>

    <!-- Notifications -->
    <div class="zone_notifications_bandeau">
      <?php
    ...
    <!-- Recherche -->
    <div id="resizeBar" class="zone_recherche_bandeau">
      <form method="post" action="" class="form_recherche_bandeau">
        <input type="submit" name="search" value="" class="logo_rechercher" />
        <input type="text" id="color_search" name="text_search" placeholder="Rechercher..." class="recherche_bandeau" />
      </form>
    </div>
  </div>
