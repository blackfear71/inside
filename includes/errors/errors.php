<?php
  ...
  $lastModificationErrors = filemtime($_SERVER['DOCUMENT_ROOT'] . '/inside/includes/assets/css/' . $_SESSION['index']['plateforme'] . '/styleErrors.css');

  // Feuille de style
  echo '<link rel="stylesheet" href="/inside/includes/assets/css/' . $plateforme . '/styleErrors.css?version=' . $lastModificationErrors . '" />';
