<?php
	...
	$onglet_4 = '<a href="/inside/portail/calendars/calendars.php?year=' . date("Y") . '&action=goConsulter" title="Calendars" class="onglet_inactif" style="border-right: solid 1px white;"><img src="/inside/includes/icons/calendars.png" alt="calendars" title="Calendars" class="logo_onglet" /></a>';
	...
	{
		$onglet_4 = '<a href="/inside/portail/calendars/calendars.php?year=' . date("Y") . '&action=goConsulter" title="Calendars" class="onglet_actif" style="border-right: solid 1px white;"><img src="/inside/includes/icons/calendars.png" alt="calendars" title="Calendars" class="logo_onglet" /></a>';
	}

	// Affichage des onglets
	echo '<div class="main_title_2">';
		echo $onglet_1, $onglet_2, $onglet_3, $onglet_4;
	echo '</div>';
?>
